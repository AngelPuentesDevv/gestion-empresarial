...
// Lista de posiciones en la empresa
const positions = [
    "Backend Developer", // Posición de backend
    "Frontend Developer", // Posición de frontend
    "Full Stack Developer", // PosiciÃ³n de lateral derecho
    "QA Tester", // Posición de QA 
    "Product Manager", // Posición de product manager 
    "Team Leader", // Posición de team leader
    "Scrum Master", // Posición de scrum master
    "Product Owner", // Posición de product owner
    "Diseñador UX/UI" // Posición de diseñador ui/ux
];
...
function loadPositions() {
    ...
    positionSelect.innerHTML = `<option value="">Seleccione una posición</option>`; // Agrega la opciÃ³n predeterminada
